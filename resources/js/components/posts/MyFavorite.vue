<template>
  <div>
    <v-container>
      ...
      <v-data-table class="elevation-1 post-index" :items="posts" :headers="headers" hide-default-header>
        <template v-slot:top>
          <v-toolbar flat dark color="blue darken-3" class="mb-1">
            ...
            <v-select v-model="sortBy" :items="sortList" item-value="value" item-text="text" flat solo-inverted hide-details readonly></v-select>
            <v-spacer></v-spacer>
          </v-toolbar>
        </template>
